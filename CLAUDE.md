...
\- /coleccion → ropa mujer (Lady Dresses, Blouses \& Shirts) — ACTIVA

\- /jerseys → PAUSADA, mostrar "Próximamente" solamente
...
\- Envío: $155 MXN fijo, se suma en checkout como línea separada
...
\- Marca de agua "By Nasus" fija en esquina inferior derecha

\- color\_sizes jsonb en tabla products
