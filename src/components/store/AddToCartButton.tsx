...
const COLOR_MAP: Record<string, string> = {
  ...
  marrón: "#795548", marino: "#1a237e", dorado: "#c8a96a", plateado: "#c0c0c0",
  // English basic
  ...
  brown: "#795548", navy: "#1a237e", gold: "#c8a96a", silver: "#c0c0c0",
  cream: "#f4f1ec",
  // Reds
                ...
                >
                  <span
                    style={{
                      ...
                      borderRadius: "50%",
                      background: css,
                      border: isLight ? "1px solid rgba(26,26,26,0.2)" : "1px solid transparent",
